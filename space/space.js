...
let ID =  document.getElementById("ID-image");
...
// light up wire light when connect
...
const audioTask = new Audio(
  "https://assets.codepen.io/127738/Among_Us-Task-complete.mp3"
);
